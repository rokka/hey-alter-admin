                ...
                <form method="post" action="{{ route('computers.update', $computer->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-3 bg-white sm:px-6 sm:py-3">
                            ...
                            <input type="text" name="donor" id="donor" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('donor', $computer->donor) }}" />
                            @error('donor')
                        ...
                        <div class="px-4 py-3 bg-white sm:px-6 sm:py-3">
                            ...
                            <input type="email" name="email" id="email" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('email', $computer->email) }}" />
                            @error('email')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
