                ...
                <form method="post" action="{{ route('schools.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-3 bg-white sm:px-6 sm:py-3">
                            ...
                            <input type="text" name="contact_person" id="contact_person" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('contact_person', '') }}" placeholder="Nicht angegeben" />
